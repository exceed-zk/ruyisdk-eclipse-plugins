...
Recommended method. Please refer to https://ruyisdk.github.io/ruyisdk-eclipse-plugins/

### Offline Installation

1. In an empty directory, download and extract all files from `ruyisdk-eclipse-plugins.site.tar.gz`
1. Follow the steps in the "Online Install" section and modify the filled information to the following content
...
推荐使用本方法安装。请参阅 https://ruyisdk.github.io/ruyisdk-eclipse-plugins/
